...
public class MainActivity extends AppCompatActivity {
    ...
    public class FetchWeatherTask extends AsyncTask<URL, Void, String[]>{
        ...
        protected String[] doInBackground(URL... urls) {
            ...
            try{
                searchResult = NetworkUtils.getResponseFromHttpUrl(apiURL);
                weatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, searchResult);
            }catch(IOException e){
                e.printStackTrace();
